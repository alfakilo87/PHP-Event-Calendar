...
var $selBtn="Mine"; // value of the date picker button (if enabled)
...
//***LISATUD****************************************************************
function setEvent2($param){
$eventStartTime=$this->mkActiveTime($start_hr,$start_min,1,$start_month,$start_day,$start_year);
$eventContent[$eventStartTime]=$content;
$eventEndTime=$this->mkActiveTime($end_hr,$end_min,1,$end_month,$end_day,$end_year);
$eventContent[$eventEndTime]=$content;
$this->calEventContent[]=$eventContent;
	if (!$id) $id=$this->cssEventContent;
$this->calEventContentId[]=$id;
	if ($url) $this->calEventContentUrl[]=$url;
