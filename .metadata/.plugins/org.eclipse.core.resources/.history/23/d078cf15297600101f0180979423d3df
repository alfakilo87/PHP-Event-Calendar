...
$e = new Event("allday1", "", 2011, 5, 2);
$e->setColorRGB("100,100,100");
$cal2->addEvent($e);
$cal2->setEvent("allday2", "", 2011, 5, 3);
$cal2->setEvent("Test3", "", 2011, 5, 3, 15, 0);
$cal2->setEvent("Test4", "", 2011, 5, 3, 15, 0);
$cal2->setEvent("Test5", "", 2011, 5, 4, 16, 0);
$cal2->setEvent("Test6", "", 2011, 5, 4, 16, 0);
$cal2->setEvent("Test7", "", 2011, 5, 4, 16, 30);
$cal2->setEvent("Test8", "", 2011, 5, 4, 16, 45);
...
$cal2->setEvent("See on pikem sündmuse kirjeldus", "", 2011, 5, 5);
...
$d2 = mktime(null ,null ,null ,null ,null ,null);
if ($d1 <= $d2) echo "on";
else echo "ei ole";
